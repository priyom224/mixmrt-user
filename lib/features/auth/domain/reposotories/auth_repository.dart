...
class AuthRepository implements AuthRepositoryInterface{
  ...
  Future<Response> registerStore(StoreBodyModel store, XFile? logo, XFile? cover, XFile? tax, XFile? registration, XFile? agreement) async {
    return apiClient.postMultipartData(
      AppConstants.storeRegisterUri, store.toJson(), [MultipartBody('logo', logo), MultipartBody('cover_photo', cover), MultipartBody('tax_document', tax), MultipartBody('registration_document', registration), MultipartBody('agreement_document', agreement)],
    );
  }
